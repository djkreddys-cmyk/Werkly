        ...
        <div className="fixed inset-0 z-[80] overflow-y-auto bg-[rgba(5,7,11,0.62)] px-4 py-6 sm:py-10">
          <div className="flex min-h-full items-start justify-center">
            ...
            <button
              ...
              className="absolute right-5 top-5 z-10 inline-flex h-10 w-10 items-center justify-center rounded-full border border-[var(--color-line)] bg-white text-xl text-slate-900 shadow-sm transition hover:bg-slate-50"
