...
type TemplateStyle = "executive" | "sidebar" | "modern" | "minimal" | "spotlight";
    ...
    <section className="hero-surface">
      <div className="section-shell print-shell py-14 sm:py-18">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="muted-copy mt-5 text-base leading-8 sm:text-lg">Open the builder in a popup, upload a candidate photo, switch between more template styles, and keep the resume preview visible on the page.</p>
        </div>
