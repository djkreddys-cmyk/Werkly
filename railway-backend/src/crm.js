...
export async function ensureCrmSchema() {
  ...
  await query(`alter table clients add column if not exists state text`);
  ...
  const result = await query(
    `update clients
        set company_name = $2,
            ...
            follow_up_status = $20,
            next_follow_up_date = $21::date,
            last_follow_up_date = $22::date,
            onboarding_source = $23,
            notes = $24,
            follow_up_notes = $25,
            agreement_file_name = $26,
            agreement_file_type = $27,
            agreement_file_data = $28,
            updated_at = now()
      where id = $1
      returning id`,
    [
