  ...
  try {
    ...
    if (inquiryType === 'company') {
      ...
      const fields = {
        ...
        motherTongue: asString(formData.get('motherTongue')),
        otherLanguages: asString(formData.get('otherLanguages')),
      ...
      rows = formatHtmlRows([
        ...
        ['Mother Tongue', fields.motherTongue],
        ['Other Languages', fields.otherLanguages],
      ...
      if (!jobSlug) {
        await recordCandidateEnquiry({
          ...
          otherLanguages: fields.otherLanguages,
          experience: fields.experience,
